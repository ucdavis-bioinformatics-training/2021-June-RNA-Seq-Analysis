...
myQuestions2 = [
  {
    ...
    answers: {
      a: "`r length(which(outdat$p.value < 0.05))`",
      b: "`r nrow(outdat)`",
      c: "`r length(which(outdat$p.value < 0.1))`"
    },
    correctAnswer: "a"
  },
  {
    ...
    answers: {
      a: "`r outdat$pathway.name[1]`",
      b: "`r outdat$pathway.name[which.min(outdat$Annotated)]`",
      c: "`r outdat$pathway.name[which.max(outdat$Annotated)]`"
    },
    correctAnswer: "c"
  },
  {
