...
1. The first thing we want to do is load the Mouse genome. Click on "Genomes" in the menu and choose "Mouse (GRCm38/mm10)". **I know this is the wrong genome, but IGV hasn't updated to the most recent yet and for our purpose here it should still work.**
